...
@section('content')
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <form class="" action="{{ route('departamentos.update', [ 'id' => $departamento->id ] ) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group {{ $errors->has( 'departamento' ) ? 'has-error' : '' }}">
            ...
            <input id="departamento" class="form-control" type="text" name="departamento" value="{{ old('departamento') ? old('departamento') : $departamento->departamento }}" placeholder="Departamento">
          </div>
